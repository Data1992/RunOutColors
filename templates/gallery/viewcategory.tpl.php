...
<?php $width = $info[0] < 800 ? 800 : $info[0]; ?>
    $('.lightbox#image-<?php echo $hash; ?>').click(function() {
      var html = $('<div id="lb-content"><center><img src="/images/gallery/<?php echo $directory; ?>/big/<?php echo $image['file']; ?>" /></center><?php echo ($image['downloadable'] === true ? '<a href="/gallery/'.$directory . '/download/' . $image['id'].'">Download</a>' : ''); ?></div><div class="fb-comments" data-href="<?php echo $_SERVER['HTTP_HOST']; ?>/gallery/<?php echo $category['directory']; ?>/<?php echo $image['id']; ?>" data-num-posts="5" data-width="<?php echo $width; ?>" data-colorscheme="light"></div>');
      $.lightbox(html, { 
